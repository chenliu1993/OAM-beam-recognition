...
conv1_2=conv_op(conv1_1,name='conv1_2',kh=3,kw=3,n_out=64,dh=2,dw=2,p=p)
...
conv2_1=conv_op(conv1_2,name='conv2_1',kh=3,kw=3,n_out=128,dh=1,dw=1,p=p)
conv2_2=conv_op(conv2_1,name='conv2_2',kh=3,kw=3,n_out=128,dh=2,dw=2,p=p)
...
conv3_1=conv_op(conv2_2,name='conv3_1',kh=3,kw=3,n_out=256,dh=1,dw=1,p=p)
...
conv4_1=conv_op(conv3_2,name='conv4_1',kh=3,kw=3,n_out=256,dh=1,dw=1,p=p)
...
conv5_1=conv_op(conv4_2,name='conv5_1',kh=3,kw=3,n_out=512,dh=1,dw=1,p=p)
conv5_2=conv_op(conv5_1,name='conv5_2',kh=3,kw=3,n_out=512,dh=1,dw=1,p=p)
#conv5_3=conv_op(conv5_2,name='conv5_3',kh=3,kw=3,n_out=512,dh=1,dw=1,p=p)
#conv5_1=conv_op(conv4_1,name='conv5_1',kh=7,kw=7,n_out=512,dh=1,dw=1,p=p)
pool5=mpool_op(conv5_2,name='pool5',kh=2,kw=2,dw=1,dh=1)
"""
...
with tf.Session() as sess:
    ...
    try:
        for i in range(2000):
            ...
            if i%10==0:
                print(sess.run(cross_entropy,feed_dict={data_in:test_imgs,label:test_labels,keep_prob:0.8}))
        ...
        saver.save(sess,'./model/model_smallk_keep/model.ckpt')
